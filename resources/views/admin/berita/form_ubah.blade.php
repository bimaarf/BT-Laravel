        ...
        <div class="card">
          ...
          <form method="POST" action="{{route('admin.berita.ubah',['key'=>$berita->key])}}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="isi" id="text" onkeyup="textKomen()"  cols="30" rows="10" class="form-control" name="isi">{{$berita->isi}}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="{{route('admin.berita.dashboard')}}" class="btn btn-outline-primary">Cencel</a>
