                   ...
                   <div class="row">
                        <div class="col-lg-8">
                            ...
                            @endforeach
                                    ...
                                    <div class=" card-header border-0 "><b>Baca Juga</b>
                                        ...
                                        <div class="trand-right-single d-flex">
                                            ...
                                            @foreach($topNews as $brt)
                                                <li><h6 class="text-danger"><a href="#">{{$brt->berita->judul}}</a></h6></li>
                                            @endforeach
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="about-prea">
                                    <p class="about-pera1 mb-25">NB : <i>you can also write news or articles, the admin will validate if the news or article does not violate the rules</i></p>
                                </div>
                                        <ul>
